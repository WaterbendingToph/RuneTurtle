...
turtle.penup()
turtle.goto(turtle.position()[0] - lowerLetterHeight / 2, turtle.position()[1] + (lowerLetterHeight / 2 - dotWidth) )
turtle.pendown()
turtle.goto(turtle.position()[0] + lowerLetterHeight / 4, turtle.position()[1] - lowerLetterHeight / 4)
