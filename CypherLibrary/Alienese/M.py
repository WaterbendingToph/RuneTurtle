...
turtle.penup()
turtle.goto(turtle.position()[0] - letterHeight / 2, turtle.position()[1] + (letterHeight / 2 - dotWidth) )
turtle.pendown()
turtle.goto(turtle.position()[0] + letterHeight / 4, turtle.position()[1] - letterHeight / 4)
